...
import { updateExpenseCategory } from "@/api-services/expense-category/updateExpenseCategory";
...
export default function ExpenseCategoryUpdateForm({ data }: { data: any }) {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    const result = await updateExpenseCategory(data._id!, nonEmptyPayload);

...
import { updateTax } from "@/api-services/tax/updateTax";
import Button from "@/components/ui/button/Button";
import Input from "@/components/ui/form/Input";
import Select from "@/components/ui/form/Select";
import convertStringToNumber from "@/helpers/convertStringToNumber";
import { removeEmptyFields } from "@/lib/removeEmptyFields";
import { statusOptions, taxOptions } from "@/lib/selectOptions";
import tagRevalidate from "@/lib/tagRevalidate";
import { redirect, useRouter } from "next/navigation";
import { useState, useRef } from "react";

export default function TaxUpdateForm({ data }: { data: any }) {
  ...
  const handleSubmit = async (formData: FormData) => {
    ...
    const result = await updateTax(data?._id, nonEmptyPayload);

...
export default function UserForm({ user }: { user: IUser }) {
    const { name, email, phoneNumber, address, role } = user
    ...
    return (
        <>
            <div className="border border-gray-200 rounded-lg p-4 shadow">
                <h3 className='font-bold 2xl:text-lg text-base text-textPrimary mb-4'>General</h3>
                <form action={handleSubmit} className="grid 2xl:space-y-4 space-y-3">
                    <div className="grid grid-cols-2 2xl:space-x-4 space-x-3">
                        ...
                        <Input type='text' label='User Role' defaultValue={role} disabled />
                    </div>
                    <Input type='text' name='name' label='Full Name' defaultValue={name} required />
                    <Input type='text' name="phoneNumber" label='Phone Number' defaultValue={phoneNumber} />
            ...
            <div className="border border-gray-200 rounded-lg p-4 shadow mt-5">
                <h3 className='font-bold 2xl:text-lg text-base text-textPrimary mb-4'>Change Password</h3>
                <form ref={formRef} action={handlePasswordSubmit} className="grid 2xl:space-y-4 space-y-3">
                    ...
                    <div>
                        <Button type='submit' variant='primary' loading={loadingPassword}>Change Password</Button>
                    </div>
                </form>
            </div>
        </>

          ...
          <div className="flex 2xl:gap-4 gap-3 lg:flex-row flex-col">
            <div className="lg:w-3/5 flex flex-col 2xl:gap-4 gap-3">
              ...
              <div className="grid grid-cols-2 2xl:gap-4 gap-3">
                ...
                <Input type="text" name="invoiceNo" label="Invoice No" defaultValue={data?.invoiceNo} />
              </div>
              <div className="grid grid-cols-2 2xl:gap-4 gap-3">
                <Input type="text" name="lotNo" label="Lot No" defaultValue={data?.lotNo} />
                <Input type="date" name="expiryDate" label="Expiry Date" defaultValue={format(new Date(data?.expiryDate), 'yyyy-MM-dd')} />
              </div>
            </div>
                ...
                <div className="flex space-x-4 justify-between text-base">
                  ...
                  <div className="grid 2xl:gap-4 gap-3 w-full">
                    <div className="grid  space-y-1 text-right items-center">
                      ...
                      <p className="text-textPrimary whitespace-nowrap">Advance Amount :</p>
